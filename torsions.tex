\section{Кручения в некоторых тензорных произведениях модулей}
    ...
    \end{equation*}
    где $I_1, I_2 \subset A$ --- идеалы в кольце $A$. 
    ...
    $$
    Заметим, что $\hat A$-модули $\frac{\Tors{\hat A}{\hat I_1}}{\Tors{\hat A}{\tau}}$ и $\Tors{\hat A}{\hat I_2}$
    $\hat A$-конечно порождены. Поэтому мы можем воспользоваться предложением 4 $\S 4$ гл. 1 книги 
    \textbf{[источник]}, которое утверждает, что расширение последовательности 
    \begin{equation*}
        0 \rightarrow \frac{\Tors{\hat A}{\hat I_1}}{\Tors{\hat A}{\tau}} \rightarrow \Tors{\hat A}{\hat M} \xrightarrow{\hat \epsilon'} \Tors{\hat A}{\hat I_2} \rightarrow 0
    \end{equation*}
    ...
    --- произвольно выбранный проообраз $\bar{z_i}$, тогда
    \begin{equation*}
        \Tors{\hat A}{\hat M}= \frac{\Tors{\hat A}{\hat I_1}}{\Tors{\hat A}{\tau}} + \left< z_1, z_2, \dots , z_m \right>_{\hat A}.
    \end{equation*}
