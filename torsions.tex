\section{Кручения в некоторых тензорных произведениях модулей}
    ...
    $$
    Отметим, что $\hat I_1, \hat I_2$ конечно порождены, согласно предложению 2.17 книги \textbf{[ссылка Атья]}, 
    ...
    \textbf{[ссылка Зуланке]}, которое утверждает, что расширение последовательности 
    \begin{equation*}
    ...
    \end{equation*}
    Воспользовавшись теоремой \ref{Mveevee} имеет место вложение
    \begin{equation*}
        \xymatrix{
            0 \ar[r]
            &N^\vee \ar[r] 
    ...
    \textbf{[ссылка Атья]}) имеют место равенства
    \begin{equation*}
